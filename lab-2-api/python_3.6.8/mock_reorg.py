...
get_method = client.put_method(
    ...
    # That bit allows us to reference the product_id phrase in our integration response 
    # as above, and thus translate (or map) it to a variable that we can use later in 
    # our Lambda code. In this case product_id_str.
    
    # The false flag is just saying that we are not going to validate the existence of 
    # that query string key.  💁‍♂ Otherwise you would have to set up separate validators
    # for both GET APIs,
    requestParameters={
